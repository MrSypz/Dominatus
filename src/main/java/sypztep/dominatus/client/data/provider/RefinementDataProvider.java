...
// Special weapons
        futures.add(generateWeaponData(writer, Items.MACE.toString(), 20, 55, 130, 0, 0, 100, 5, 18, 0, 0, 1));           // Yellow
...
// Axes - Higher damage, lower accuracy
    ...
    private List<CompletableFuture<?>> generateLeatherArmor(DataWriter writer) {
        List<CompletableFuture<?>> futures = new ArrayList<>();
        futures.add(generateWeaponData(writer, Items.LEATHER_HELMET.toString(), 20, 0, 0, 8, 25, 100, 0, 0, 4, 10, 10));
        futures.add(generateWeaponData(writer, Items.LEATHER_CHESTPLATE.toString(), 20, 0, 0, 12, 35, 100, 0, 0, 6, 16, 10));
        futures.add(generateWeaponData(writer, Items.LEATHER_LEGGINGS.toString(), 20, 0, 0, 10, 30, 100, 0, 0, 5, 12, 10));
        futures.add(generateWeaponData(writer, Items.LEATHER_BOOTS.toString(), 20, 0, 0, 8, 25, 100, 0, 0, 4, 10, 10));
        return futures;
    }

    private List<CompletableFuture<?>> generateChainmailArmor(DataWriter writer) {
        List<CompletableFuture<?>> futures = new ArrayList<>();
        futures.add(generateWeaponData(writer, Items.CHAINMAIL_HELMET.toString(), 20, 0, 0, 6, 20, 100, 0, 0, 6, 15, 5));
        futures.add(generateWeaponData(writer, Items.CHAINMAIL_CHESTPLATE.toString(), 20, 0, 0, 10, 28, 100, 0, 0, 10, 24, 5));
        futures.add(generateWeaponData(writer, Items.CHAINMAIL_LEGGINGS.toString(), 20, 0, 0, 8, 24, 100, 0, 0, 8, 20, 5));
        futures.add(generateWeaponData(writer, Items.CHAINMAIL_BOOTS.toString(), 20, 0, 0, 6, 20, 100, 0, 0, 6, 15, 5));
        return futures;
    }

    private List<CompletableFuture<?>> generateIronArmor(DataWriter writer) {
        List<CompletableFuture<?>> futures = new ArrayList<>();
        futures.add(generateWeaponData(writer, Items.IRON_HELMET.toString(), 20, 0, 0, 4, 15, 100, 0, 0, 8, 20, 5));
        futures.add(generateWeaponData(writer, Items.IRON_CHESTPLATE.toString(), 20, 0, 0, 6, 18, 100, 0, 0, 12, 28, 5));
        futures.add(generateWeaponData(writer, Items.IRON_LEGGINGS.toString(), 20, 0, 0, 5, 16, 100, 0, 0, 10, 24, 5));
        futures.add(generateWeaponData(writer, Items.IRON_BOOTS.toString(), 20, 0, 0, 4, 15, 100, 0, 0, 8, 20, 5));
        return futures;
    }

    private List<CompletableFuture<?>> generateGoldenArmor(DataWriter writer) {
        List<CompletableFuture<?>> futures = new ArrayList<>();
        futures.add(generateWeaponData(writer, Items.GOLDEN_HELMET.toString(), 20, 0, 0, 10, 30, 100, 0, 0, 6, 16, 2));
        futures.add(generateWeaponData(writer, Items.GOLDEN_CHESTPLATE.toString(), 20, 0, 0, 15, 40, 100, 0, 0, 10, 24, 2));
        futures.add(generateWeaponData(writer, Items.GOLDEN_LEGGINGS.toString(), 20, 0, 0, 12, 35, 100, 0, 0, 8, 20, 2));
        futures.add(generateWeaponData(writer, Items.GOLDEN_BOOTS.toString(), 20, 0, 0, 10, 30, 100, 0, 0, 6, 16, 2));
        return futures;
    }

    private List<CompletableFuture<?>> generateDiamondArmor(DataWriter writer) {
        List<CompletableFuture<?>> futures = new ArrayList<>();
        futures.add(generateWeaponData(writer, Items.DIAMOND_HELMET.toString(), 20, 0, 0, 8, 25, 100, 0, 0, 10, 24, 2));
        futures.add(generateWeaponData(writer, Items.DIAMOND_CHESTPLATE.toString(), 20, 0, 0, 12, 32, 100, 0, 0, 16, 36, 2));
        futures.add(generateWeaponData(writer, Items.DIAMOND_LEGGINGS.toString(), 20, 0, 0, 10, 28, 100, 0, 0, 12, 30, 2));
        futures.add(generateWeaponData(writer, Items.DIAMOND_BOOTS.toString(), 20, 0, 0, 8, 25, 100, 0, 0, 10, 24, 2));
        return futures;
    }

    private List<CompletableFuture<?>> generateNetheriteArmor(DataWriter writer) {
        List<CompletableFuture<?>> futures = new ArrayList<>();
        futures.add(generateWeaponData(writer, Items.NETHERITE_HELMET.toString(), 20, 0, 0, 10, 30, 100, 0, 0, 12, 28, 1));
        futures.add(generateWeaponData(writer, Items.NETHERITE_CHESTPLATE.toString(), 20, 0, 0, 15, 40, 100, 0, 0, 20, 45, 1));
        futures.add(generateWeaponData(writer, Items.NETHERITE_LEGGINGS.toString(), 20, 0, 0, 12, 35, 100, 0, 0, 16, 36, 1));
        futures.add(generateWeaponData(writer, Items.NETHERITE_BOOTS.toString(), 20, 0, 0, 10, 30, 100, 0, 0, 12, 28, 1));
        return futures;
    }
    ...
    private List<CompletableFuture<?>> generateWristItems(DataWriter writer) {
        List<CompletableFuture<?>> futures = new ArrayList<>();
        futures.add(generateWeaponData(writer, ModItems.YURIA_BRACKET.toString(), 20, 15, 45, 8, 25, 100, 0, 0, 2, 10, 5));
        return futures;
    }

    private CompletableFuture<?> generateWeaponData(DataWriter writer, String itemName, int maxLvl, int startAccuracy, int endAccuracy, int startEvasion, int endEvasion, int maxDurability, int startDamage, int endDamage, int startProtection, int endProtection, int repairPoint) {
