        ...
        for (int i = 0; i < statItems.size(); i++) {
            ...
            if (item.isHeader()) {
                ...
                if (statValue != null) {
                    ...
                    drawCenteredTextWithShadow(context, baseText, columnCenters[1], adjustedTextY, BASE_VALUE_COLOR);
                    ...
                    drawCenteredTextWithShadow(context, totalText, columnCenters[3], adjustedTextY, TOTAL_VALUE_COLOR);
                }
