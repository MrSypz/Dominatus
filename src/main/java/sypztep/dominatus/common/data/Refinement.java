...
public record Refinement(int refine, int accuracy, int evasion, int durability, float damage, float protection) {
    public static final Codec<Refinement> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.FLOAT.optionalFieldOf("protection",0.0f).forGetter(Refinement::protection)
