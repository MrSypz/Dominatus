...
public class ModEntityAttributes {
    ...
    static {
        ...
        GENERIC_ACCURACY = register("generic.accuracy", new ClampedEntityAttribute("attribute.name.generic.accuracy", 50, 0.0, 500.0).setTracked(true));
        GENERIC_EVASION = register("generic.evasion", new ClampedEntityAttribute("attribute.name.generic.evasion", 20, 0.0, 500.0).setTracked(true));
        GENERIC_CRIT_CHANCE = register("generic.crit_chance", new ClampedEntityAttribute("attribute.name.generic.crit_chance", 0, 0.0, 1.0).setTracked(true));
        GENERIC_CRIT_DAMAGE = register("generic.crit_damage", new ClampedEntityAttribute("attribute.name.generic.crit_damage", 0.5, 0.0, 64.0).setTracked(true));
    }
