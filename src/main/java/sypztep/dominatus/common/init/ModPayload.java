...
public final class ModPayload {
    public static void init() {
        ...
        PayloadTypeRegistry.playC2S().register(GemInvButtonPayloadC2S.ID, GemInvButtonPayloadC2S.CODEC); // Client to Server
        ...
        ServerPlayNetworking.registerGlobalReceiver(GemInvButtonPayloadC2S.ID, new GemInvButtonPayloadC2S.Receiver());
    }
}
