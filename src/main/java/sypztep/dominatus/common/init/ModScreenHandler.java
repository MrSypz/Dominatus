...
import sypztep.dominatus.common.screen.RarityScreenHandler;
...
public class ModScreenHandler {
    ...
    public static ScreenHandlerType<RarityScreenHandler> RARITY_SCREEN_HANDLER_TYPE;
    public static void init() {
        ...
        RARITY_SCREEN_HANDLER_TYPE = Registry.register(Registries.SCREEN_HANDLER, "rarity",
                new ScreenHandlerType<>((syncId, inventory) -> new RarityScreenHandler(syncId, inventory, ScreenHandlerContext.EMPTY), FeatureFlags.VANILLA_FEATURES));
    }
}
