...
public class ModScreenHandler {
    ...
    public static ScreenHandlerType<ReformScreenHandler> REFORM_SCREEN_HANDLER_TYPE;
    public static void init() {
        ...
        REFORM_SCREEN_HANDLER_TYPE = Registry.register(Registries.SCREEN_HANDLER, "reform",
                new ScreenHandlerType<>((syncId, inventory) -> new ReformScreenHandler(syncId, inventory, ScreenHandlerContext.EMPTY), FeatureFlags.VANILLA_FEATURES));
    }
}
