...
public class QuickReflexPassive extends BaseAttributePassive {
    ...
    public QuickReflexPassive() {
        super(
                ...
                Text.literal("Your quick reflexes increase evasion by 5"),
                "agility",
                20,
                2
        );
    ...
    protected void applyAttributeModifiers(LivingEntity entity) {
        applyAttributeModifier(entity, ModEntityAttributes.EVASION, MODIFIER_ID, 5.0, EntityAttributeModifier.Operation.ADD_VALUE);
    }
